 ...
 */
@Configuration public class HbaseTableScanHandler {
    ...
    private static final HbaseTableScanHandler
            NONE =
        ...
        if (registry.containsBeanDefinition(BEAN)) {
            ...
            beanDefinition.getConstructorArgumentValues()
                          .addIndexedArgumentValue(0,
                                                   packageNames.toArray(new String[packageNames
                                                           .size()]));
    ...
    static class Registrar implements ImportBeanDefinitionRegistrar {
        ...
        private Set<String> getPackagesToScan(AnnotationMetadata metadata) {
            AnnotationAttributes
                    attributes =
                    AnnotationAttributes.fromMap(metadata.getAnnotationAttributes(
                            HbaseTable.class.getName()));
